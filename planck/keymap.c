 ...
 * |   {  |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  | Shift|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  | Tab  | Lower|    Space    | Raise| Bksp | Esc  | #    | Enter|
 * `-----------------------------------------------------------------------------------'
 */
[_DEFAULT] = {
  ...
  {KC_LCBR, KC_Z,    KC_X,    KC_C,   KC_V,  KC_B,   KC_N,   KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT},
  {KC_LCTL, KC_LGUI, KC_LALT, KC_TAB, LOWER, KC_SPC, KC_SPC, RAISE, KC_BSPC, KC_ESC,  KC_NUHS, KC_ENT}
},
